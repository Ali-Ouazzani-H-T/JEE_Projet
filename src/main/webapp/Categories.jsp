...
<body class="bg-dark text-white">
	...
	<table id="categorie-table"
		...
		<tbody>
			...
			<tr>
				...
				<td><button class="btn btn-success edit-product"
						onclick="editCategorie(<%=categorie.getIdCategorie()%>)"
						data-categorie-id="<%=categorie.getIdCategorie()%>">Edit</button></td>
				<td><button class="btn btn-danger delete-product"
						onclick="deleteCategorie(<%=categorie.getIdCategorie()%>)"
						data-categorie-id="<%=categorie.getIdCategorie()%>">Delete</button></td>
			</tr>
			<%
			}
			%>
	...
	<button class="btn btn-primary" onclick="createCategorie()">Add
		Categorie</button>
